    ...
    <div>
      ...
      <div>
        <div className="text-4xl font-semibold text-center my-10">
          ...
          कृषि विशेषज्ञ: खेती के ज्ञान का स्रोत।
          </p>
        </div>
      </div>

      {/* Tabs Section */}
      <div className="hidden lg:flex gap-5 -mt-5 mx-auto w-max bg-caribbeangreen-800 text-white p-1 rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]">
